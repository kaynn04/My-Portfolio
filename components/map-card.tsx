  ...
  return (
    <div className="relative flex h-full w-full flex-col justify-between overflow-hidden rounded-3xl border border-line bg-surface p-7 transition-colors duration-200">
      ...
      <div className="relative my-4 flex min-h-52 flex-1 items-center justify-center overflow-hidden">
        <div className="relative aspect-square w-[min(150%,28rem)] max-w-none shrink-0">
          <div
            aria-hidden="true"
            className="absolute inset-0 bg-muted opacity-25 [mask-image:url('/ph.svg')] [mask-position:center] [mask-repeat:no-repeat] [mask-size:contain] spider:bg-[#2A2A32] spider:opacity-60"
          />

          <div className="absolute top-[41.4%] left-[45.7%] flex h-3 w-3 -translate-x-1/2 -translate-y-1/2">
            <span className="absolute -top-7 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-full border border-line bg-surface/90 px-2 py-0.5 text-xs font-semibold text-foreground shadow-sm spider:border-[#1f1f22] spider:bg-[#1d1d20]/90 spider:text-gray-300">
              Metro Manila
            </span>
